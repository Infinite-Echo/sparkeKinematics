...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.clear_trajectory_plot_button, 1, 2, 1, 1)
        self.toggle_labels_button = QtWidgets.QPushButton(self.dockWidgetContents_4)
        self.toggle_labels_button.setObjectName("toggle_labels_button")
        self.gridLayout.addWidget(self.toggle_labels_button, 1, 0, 1, 1)
        self.toggle_trajectory_button = QtWidgets.QPushButton(self.dockWidgetContents_4)
        self.toggle_trajectory_button.setObjectName("toggle_trajectory_button")
        self.gridLayout.addWidget(self.toggle_trajectory_button, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.plot_trajectory_button, 0, 2, 1, 1)
        self.reset_trajectory_button = QtWidgets.QPushButton(self.dockWidgetContents_4)
        self.reset_trajectory_button.setObjectName("reset_trajectory_button")
        self.gridLayout.addWidget(self.reset_trajectory_button, 0, 1, 1, 1)
        self.reset_vel_button = QtWidgets.QPushButton(self.dockWidgetContents_4)
        self.reset_vel_button.setObjectName("reset_vel_button")
        self.gridLayout.addWidget(self.reset_vel_button, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toggle_labels_button.setText(_translate("MainWindow", "Toggle Labels"))
        self.toggle_trajectory_button.setText(_translate("MainWindow", "Toggle Trajectory"))
        self.plot_trajectory_button.setText(_translate("MainWindow", "Plot Trajectory"))
        self.reset_trajectory_button.setText(_translate("MainWindow", "Reset Trajectory"))
        self.reset_vel_button.setText(_translate("MainWindow", "Reset Velocity"))
